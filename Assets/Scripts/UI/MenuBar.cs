...
public class MenuBar : MenuScreen
{
    ...
    // UI Buttons
    Button m_DungeonScreenMenuButton;
    ...
    protected override void SetVisualElements()
    {
        ...
        m_DungeonScreenMenuButton= m_Root.Q<Button>(k_DungeonScreenMenuButton);
    ...
    protected override void RegisterButtonCallbacks()
    {
        ...
        m_DungeonScreenMenuButton?.RegisterCallback<ClickEvent>(ShowDungeonScreen);
        /*
    ...
    {
        ActivateButton(m_DungeonScreenMenuButton);
        MoveActiveMarker(m_DungeonScreenMenuButton);
    }
